...
* @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
*/
class block_customhub_hublisting extends HTML_QuickForm_input {
    ...
    function toHtml() {
        ...
        $module = array('name'=>'block_customhub_hublisting', 'fullpath'=>'/blocks/customhub/yui/hublisting/hublisting.js',
            'requires'=>array('node', 'event', 'transition', 'escape'));

        $PAGE->requires->js_init_call('M.block_customhub_hublisting.init',
                 array(array(
...
MoodleQuickForm::registerElementType('customhublisting', "$CFG->dirroot/blocks/customhub/hublisting.php", 'block_customhub_hublisting');
